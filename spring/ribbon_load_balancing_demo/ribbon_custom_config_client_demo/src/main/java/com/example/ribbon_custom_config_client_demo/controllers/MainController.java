package com.example.ribbon_custom_config_client_demo.controllers;

import com.example.ribbon_custom_config_client_demo.services.UrlService;
...
//        String result = restTemplate.getForObject(urlService.getUrl() + "/service" , String.class);
        String result = restTemplate.getForObject("http://" + ribbonServiceName + "/stub/service", String.class);
